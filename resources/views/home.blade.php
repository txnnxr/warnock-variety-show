...
{{--            </p>--}}
            <div class="text-center">
                <a href="{!!action([\App\Http\Controllers\ShowController::class, 'show'], ['show' => \App\Models\Show::latest('date')->first()->id])!!}" class="btn btn-primary btn-lg p-4">Upcoming Show</a>
            </div>
        </div>
    </div>
    <style>
